...
class Colposcopia extends Model
{
    ...
    'turno_id', 'fum', 'biopsia_id', 'citologia_id', 'hallazgo_id', 'responsable', 'establecimiento', 'localidad', 'test_vph', 'observaciones', 'zona_trans', 'tratamiento', 'seguimiento','estado'];
