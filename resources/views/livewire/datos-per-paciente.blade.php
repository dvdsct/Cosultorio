...
>>>>>>> f235ad49d75ac42bcc775b02083728315d914e97
    ...
    <div class="modal fade show" id="modal-datos-pac" aria-labelledby="modal-default" style="display:block" aria-hidden="true" wire:ignore.self>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <button class="btn btn-outline-secondary" wire:click='addEmail' id="button-addon2">Button</button>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <button class="btn btn-outline-secondary" wire:click='addTel' id="button-addon2">Button</button>
