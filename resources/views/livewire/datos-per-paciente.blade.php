    ...
    <div class="card card-info">
        ...
        <div class="card-body p-0" style="display: block;">
            ...
            <div class="row">
                ...
                <div class="col-4 d-flex flex-column px-5 py-2">
                    <!-- <h5><strong>Email: </strong> {{ $consulta->perfiles ? $consulta->perfiles->personas ? $consulta->perfiles->personas->correo_x_personas ? $consulta->perfiles->personas->correo_x_personas->correos->first()->direccion : 'Sin dirección' : 'Sin correo_x_personas' : 'Sin personas' }}
</h5> -->
