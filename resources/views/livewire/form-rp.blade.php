<div class="card card-primary mr-2" id="{{ $rp->id }}">
    <div class="card-header">
        <h3 class="card-title">R/p</h3>
    </div>
    ...
    <div class="card-body">
        ...
        @if ($rp->estado == '1')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control rounded-0" id="exampleInputRounded0"
                    placeholder="3 comprimidos c/ 8 hs" wire:model='indicacion' wire:keydown.enter='recetar'>
                <div class="text-red" style="font-weight: bold;">
                    @error('indicacion')
                        {{ $message }}
                    @enderror
        ...
        @else
            ...
            <div class="form-group">
                <label for="exampleInputRounded0">Indicacion </label>
                <input type="text" disabled class="form-control rounded-0" id="exampleInputRounded0"
                    placeholder="3 comprimidos c/ 8 hs" wire:model='indicacion' wire:keydown.enter='recetar'>
            </div>
        @endif
    </div>
