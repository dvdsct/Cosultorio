<div>
    <div class="modal fade" id="modal-laboratorio" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="addd_lab">PEDIDOS LABORATORIO

                    <label for="">Todas</label><input type="checkbox" wire:model='todas'>
                    <label for="">Hemograma</label><input type="checkbox" wire:model='hemo'>
