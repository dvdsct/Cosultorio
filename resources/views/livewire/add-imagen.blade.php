<div>
                ...
                <div class="modal-content">
                            ...
                            <div class="row pt-4 pl-2 pb-1">
                                <div class="form-check">
                                    <input type="checkbox" id="todas" wire:model='todas'
                                        style="transform: scale(1.5);" wire:click='selectAll'>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label pl-2" for="eco_gin"
                                            style="cursor: pointer;">Ecografía Ginecologica <!-- {{ $eco_gin }} -->
                                        </label>
                                    </div>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" class="btn btn-secondary"
                            wire:click='save_img("pedido")'>Aceptar</button>
                    </div>
    ...
    @if ($cargaForm)
        <div class="form-group">
            ...
            <textarea class="form-control" rows="3" placeholder="Descripcion de los resultados.."
                wire:model='observaciones' id="obs"></textarea>
        </div>
</div>
...
<div class="row d-flex justify-content-end pt-2 mb-2">
    <div class="col">
        <a class="btn bg-purple btn-block" href="{{ route('pdfImagen', $consulta->id) }}" target="_blank">
            <strong>
