                    ...
                    <form wire:submit="add_lab">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="col-md-12">
                                    <div class="form-check">
                                        <input type="checkbox" id="general" wire:model='' style="transform: scale(1.5);">
                                        <label class="pl-2"> <strong>Evaluacion General y Hematológica </strong></label>
                                    </div>
                                    <div class="form-check">
                                ...
                                <div class="col-md-12">
                                    <div class="form-check">
                                        <input type="checkbox" id="general" wire:model='' style="transform: scale(1.5);">
                                        <label class="pl-2"><strong> Evaluacion de la funcion renal y Urinaria </strong></label>
                                    </div>
                                    <div class="form-check">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input type="checkbox" id="general" wire:model='' style="transform: scale(1.5);">
                                    <label class="pl-2"><strong> Evaluacion Ginecológica</strong></label>
                                </div>
                                <div class="form-check">
