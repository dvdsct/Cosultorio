<div>
    <div class="row d-flex justify-content-between" style="padding-top: 20px;">
        ...
        <div class="col-md-3 col-xs-3 pt-2">
            @can('crearturno')
                <button type="button" class="btn btn-block btn-info" id="btn_turno" data-target="modal-default"
                                        ...
                                        @if ($turno->estado != '3')
                                            @can('atender')
                                                <div class="btn-group">
                                                    ...
                                                    @elseif ($turno->motivo == '2')
                                                        <a type="button"
                                                            href="{{ url('consulta') }}/{{ $turno->consultas->id }}"
                                                            class="btn btn-info btn-sm">Atender</a>
                                                    @endif
                                                </div>
                                            @endcan
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nombre"
                                            {{ $onOff }} wire:model='nombre' placeholder="Nombre">
                                    </div>
                                </div>
