                                        ...
                                        @else
                                            ...
                                            <td>
                                                <div class="btn-group" style="width: 100%;">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-danger btn-flat rounded-right mr-1"
                                                        wire:click=''>
                                        ...
                                        @if ($this->consulta->estado == '3')
                                            <td>
                                                <button type="button"
                                                    ...
                                                    style="width: 100%;" data-toggle="modal" wire:click="modalEditLab">
                                        ...
                                        @else
                                            <td>
                                                <div class="btn-group" style="width: 100%;">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-warning btn-flat rounded-right mr-1"
                                        ...
                                        @else
                                            <td>
                                                <div class="btn-group" style="width: 100%;">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-primary btn-flat rounded-right mr-1"
                                                        wire:click=''>
                                                        <i class="fas fa-file-upload"></i>
                                                    </button>
                                                    <button type="button"
