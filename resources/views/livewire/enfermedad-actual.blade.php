                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="display:flex; justify-content: flex-end;">
                                            <div class="btn-group" style="width: 60%;">
                                                <button type="button" class="btn btn-warning btn-flat rounded-left mr-1" wire:click='dispatch("modalOnLab")'>
                                                    <i class="fas fa-plus-circle"></i>
                                                </button>
...
<!-- -------------------- BOTON DE IMAGEN ----------------------------- -->
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <button type="button" class="btn btn-block btn-success mt-2" style="height: 90px;" wire:click='finConsulta()'>
                                        <i class="fa fa-check-circle fa-2x"></i> <br>
                                        <strong> FINALIZAR CONSULTA </strong></button>
                                </div>

                                <div class="col-4 pl-0">
                                    <a type="button" class="btn btn-block btn-secondary mt-2 pt-3" style="height: 90%;" href="{{route('pdf.show' , $consulta->id)}}" target="_blank">
        ...
        <div class="modal fade show" id="modal-laboratorio" aria-labelledby="modal-default" style="background-color: rgba(0, 0, 0, 0.5); display:block" aria-hidden="true" wire:ignore.self>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                            ...
                            <div class="col-md-4">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="hb_glico" style="cursor: pointer;">Hemoglobina
                                            glicosilada</label>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="lysteria" style="cursor: pointer;">Lysteria monocitogenes
                                            Ag</label>
                                    </div>
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" wire:click='dispatch("modalOnLab")'>Cancelar</button>
