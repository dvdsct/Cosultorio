                        ...
                        <div class="card col-5 ">
                            ...
                            <div class="card-body p-0">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="btn-group" style="width: 80%;">
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-flat mr-1" wire:click='dispatch("modalImgOn")'>
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <button type="button"
                                                        class="btn btn-danger btn-flat rounded-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="btn-group" style="width: 80%;">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-warning btn-flat rounded-right">
                                                        <i class="fas fa-trash"></i>
                                                    </button>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="btn-group" style="width: 80%;">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-primary btn-flat rounded-right">
                                                        <i class="fas fa-trash"></i>
                                                    </button>
                                                </div>

                                            </td>
                                            <td><span class="badge bg-primary">{{ count($consulta->recetas) }}</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <button type="button" class="btn btn-block btn-success mt-2" style="height: 80px;"
                                    wire:click='finConsulta()'>FINALIZAR CONSULTA E IMPRIMIR</button>
