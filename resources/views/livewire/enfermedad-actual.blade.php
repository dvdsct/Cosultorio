                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col-5 ">
                                        ...
                                        <tbody>
                                                <tr class="table-border-bottom">
                                                    <td>           <button type="button" class="btn btn-danger " data-toggle="modal"
                                                        ...
                                                        <strong> Imagen </strong> </button> </td>
                                                    <td>
                                                        <span class="badge bg-danger">{{$total_lab}}</span>
                                                    </td>
                                                    <td class="p-2">
                                                ...
                                                <tr class="table-border-bottom">
                                                    ...
                                                    <td class="p-2">
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <button type="button" class="btn btn-danger" wire:click='delAll("lab")'>
                                                                <i class="fas fa-trash"></i>
                                                            </button>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr class="table-border-bottom">
                                                    <td>                       <button type="button" class="btn btn-info " data-toggle="modal"
                                                        ...
                                                        <strong> Receta </strong> </button> </td>
                                                    <td>
                                                        <span class="badge bg-danger">{{$total_lab}}</span>
                                                    </td>
                                                    <td class="p-2">
                            ...
                            <button type="button" wire:click='finConsulta()'>fdkshfkjh</button>
                        </div>
                    </div>
                </form>
            </div>
