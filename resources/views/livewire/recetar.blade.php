        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12 col-md-6">
                        <table id="myTable" class="table table-hover ml-4" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="p-0">{{ $v->presentacion }}</td>
                                    <td class="p-0">{{ $v->droga }}</td>
                                    <td class="p-0"><button class="btn btn-primary" wire:click='indicacionar({{ $v->id }})'><i class="bi bi-journal-check"></i> Recetar</button></td>
                                </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div class="col-12 col-md-6">
                            <div class="recetados" style="background-color: orange;">
                                ...
                                <div class="row">
                                    ...
                                    <div>
                                        <button class="btn btn-danger btn-sm col-2" type="button" wire:click='borrarRecetado({{ $r->id }})'> <i class="far fa-trash-alt"></i> </button></div>
                                </div>
                                @endforeach
                            </div>
                        </div>
