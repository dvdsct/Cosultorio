                ...
                <div style="width: 100%;">
                    ...
                    <div class="input-group">
                        <input type="text" wire:model="query" wire:keydown.enter='searchV'
                            class="form-control float-right" placeholder="Droga/Marca">
                                        ...
                                        <tbody>
                                            @foreach ($vademecum as $v)
                                                <tr style="cursor: pointer;">
                                                    <td class="p-0" wire:click='addRp({{ $v->id }})'> <span
                                                            style="font-size: 12px;"> {{ $v->nombre }} </span></td>
                                                    <td class="p-0" wire:click='addRp({{ $v->id }})'> <span
                                                            style="font-size: 12px;"> {{ $v->droga }} </span> </td>
                                                    <td class="p-0" wire:click='addRp({{ $v->id }})'> <span
                                                            style="font-size: 12px;"> {{ $v->presentacion }} </span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
