                            ...
                            <table id="myTable" class="table table-hover" >
                                ...
                                <tbody>
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td class="p-0" wire:click='indicacionar({{ $v->id }})'> <span style="font-size: 12px;"> {{ $v->nombre}} </span></td>
                                        <td class="p-0" wire:click='indicacionar({{ $v->id }})'> <span style="font-size: 12px;"> {{ $v->droga }} </span> </td>
                                        <td class="p-0" wire:click='indicacionar({{ $v->id }})'> <span style="font-size: 12px;"> {{ $v->presentacion }} </span> </td>
                                    </tr>
                                    @endforeach
                                </tbody>
