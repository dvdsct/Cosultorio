        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <select class="custom-select rounded-0 col-md-6" aria-label="Default select example"
                        wire:model='metodo_anti' wire:change='setStatus'>
                ...
                <div class="col-md-6">
                    <div class="custom-control custom-switch mt-3">
                        <input type="checkbox" class="custom-control-input" id="customSwitchCP" wire:model='check_cp'
                            wire:click='cir_previas'>
                        <label class="custom-control-label" for="customSwitchCP">Cirugías Previas</label>
                    </div>
                    <br>
                    <select class="custom-select rounded-0 col-md-6" aria-label="Default select example"
                        wire:model='ciru_prev' {{ $v_cp }}>
                    ...
                    <div class="custom-control custom-switch mt-3">
                        <input type="checkbox" class="custom-control-input" id="customSwitchEA"
                            wire:model.live='embarazo'>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <select class="custom-select rounded-0" aria-label="Default select example"
                ...
                <div class="col-md-4">
                    <div class="row">
                        <div class="custom-control custom-switch ml-2">
                            <input type="checkbox" class="custom-control-input" id="customSwitch1" wire:click='test_vph'
                                wire:model='check_vph'>
                    ...
                    <input type="date" class="form-control mt-2" {{ $v_test }} wire:model='fec_tam'
                        class="form-control">
                </div>
                ...
                <div class="col-md-4">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="customSwitch2"
                            wire:click='pap_previo' wire:model='check_pap'>
